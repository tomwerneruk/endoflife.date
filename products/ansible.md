...
## [Ansible-core Compatibility](https://docs.ansible.com/ansible/latest/reference_appendices/release_and_maintenance.html#ansible-community-changelogs)

{% include table.html
labels="Ansible Community Package Release,Core version dependency"
fields="releaseCycle,ansibleCoreVersion"
types="string,string"
rows=page.releases %}

Ansible-core Python compatibilities can be found on [the Ansible page](/ansible-core#python-compatibility).
